...
// import { paths } from '@/types/api-docs'; // generated by openapi-generator, Do not make direct changes to the file.
...
//   const res = await fetch(`${process.env.NEXT_PUBLIC_API_HOST_V2}${_url}`, {
